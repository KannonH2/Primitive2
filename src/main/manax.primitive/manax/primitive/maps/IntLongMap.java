...
/* 323 */     Objects.requireNonNull(mappingFunction);
/*     */     
/* 325 */     if (!containsKey(key)) {
/* 326 */       long v = mappingFunction.applyAsLong(key);
/* 327 */       put(key, v);
/* 328 */       return v;
/*     */     } 
/* 330 */     return get(key);
...
/*     */   
/*     */   void putAll(IntLongMap paramIntLongMap);
/*     */   
/*     */   void clear();
/*     */   
/*     */   IntSet keySet();
...
/* Location:              C:\Users\Manax\.gradle\caches\modules-2\files-2.1\io.github.andyalvarezdev\primitive\2.0.0-SNAPSHOT\4e4aa0ef5b5777a32b87dc244c52e046907e1af2\primitive-2.0.0-SNAPSHOT.jar!\io\github\andyalvarezdev\primitive\maps\IntLongMap.class
